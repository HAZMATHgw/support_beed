...
def plan_beads(
    ...
    for i, sup in enumerate(support):
        ...
        for region, geom, prm in (
            ...
            margin = max(0.0,
                         0.5 * prm.bead_diameter_mm - gen.xy_clearance_mm + safety)
            ...
            if gen.refine_thin_regions and min_bead > 0:
                ...
                for _ in range(gen.fill_generations):
                    if leftover.is_empty or leftover.area < 1e-6:
                        break
                    ...
                    fine = support_bead_generate_centers(
                        leftover, fine_prm, i, grid_origin,
                    ...
                    leftover = clean(leftover.difference(unary_union([
